...
EffectiveBohrRadius[a_String]:=BohrRadius*PenetrationStatic[a]*ElectronMass/EffectiveElectronMass[a];
...
SpinOrbitGap::usage="SpinOrbitGap[\"GaAs\"[,\:0442\:0435\:043c\:043f\:0435\:0440\:0430\:0442\:0443\:0440\:0430]] Spin Orbital Gap \:0438\:043b\:0438 SpinOrbitGap[\"\!\(\*SubscriptBox[\(Al\), \(x\)]\)\!\(\*SubscriptBox[\(Ga\), \(1 - x\)]\)As\",x,Temperature]";InderectEnergyGapL6\[CapitalGamma]7::usage="InderectEnergyGapX8\[CapitalGamma]7[\"AlGaAs\",x_] Inderect Energy Gap";
InderectEnergyGapX8\[CapitalGamma]7::usage="InderectEnergyGapX8\[CapitalGamma]7[\"AlGaAs\",x_] Inderect Energy Gap";LatticeConstant::usage="Lattice constant";
...
EnergyGap["GaAs",t_:0]:=(1519.2(300 Kelvin-t)+1420. t)meV/(300 Kelvin);
EnergyGap["InAs",t_:0]:=(418.(300 Kelvin-t)+354. t)meV/(300 Kelvin);
EnergyGap["InP",t_:0]:=(1423.6(300 Kelvin-t)+1340. t)meV/(300 Kelvin);
EnergyGap["InSb",t_:0]:=(235.2(300 Kelvin-t)+180. t)meV/(300 Kelvin);
EnergyGap["GaP",t_:0]:=(2869.(300 Kelvin-t)+2780. t)meV/(300 Kelvin);
EnergyGap["GaSb",t_:0]:=(811.3(300 Kelvin-t)+700. t)meV/(300 Kelvin);
EnergyGap["AlAs",t_:0]:=(3130(300 Kelvin-t)+2950. t)meV/(300 Kelvin);
EnergyGap["AlSb",t_:0]:=(2320(300 Kelvin-t)+2219. t)meV/(300 Kelvin);
EnergyGap[a_String,b_String,x_,t_:0]:=(1-x)*EnergyGap[a,t]+x*EnergyGap[b,t];
EnergyGap["AlGaAs",x_,T_]:=600(1.155x+0.37x^2-1.15x(T-300 Kelvin)10^-4)meV;
...
SpinOrbitGap["GaAs",t_:0]:=(341.(300 Kelvin-t)+340. t)meV/(300 Kelvin);
SpinOrbitGap["InAs",t_:0]:=(380.(300 Kelvin-t)+371. t)meV/(300 Kelvin);
SpinOrbitGap["InP",t_:0]:=(108.(300 Kelvin-t)+110. t)meV/(300 Kelvin);
SpinOrbitGap["InSb",t_:0]:=(235.2(300 Kelvin-t)+180. t)meV/(300 Kelvin);
SpinOrbitGap["GaP",t_:0]:=(820.(300 Kelvin-t)+800. t)meV/(300 Kelvin);
SpinOrbitGap["GaSb",t_:0]:=(811.3(300 Kelvin-t)+700. t)meV/(300 Kelvin);
SpinOrbitGap["AlAs",t_:0]:=(275.(300 Kelvin-t)+275. t)meV/(300 Kelvin);
SpinOrbitGap["AlSb",t_:0]:=(656.(300 Kelvin-t)+750. t)meV/(300 Kelvin);
SpinOrbitGap[a_String,b_String,x_,t_:0]:=(1-x)*SpinOrbitGap[a,t]+x*SpinOrbitGap[b,t];
...
EffectiveElectronMass["GaAs",t_:0]:=(0.0665(300 Kelvin-t)+0.0679 t)ElectronMass/(300 Kelvin);
EffectiveElectronMass["InAs",t_:0]:=(0.023(300 Kelvin-t)+0.027 t)ElectronMass/(300 Kelvin);
EffectiveElectronMass["InP",t_:0]:=(0.079(300 Kelvin-t)+0.077 t)ElectronMass/(300 Kelvin);
EffectiveElectronMass["InSb",t_:0]:=(0.0139(300 Kelvin-t)+0.013 t)ElectronMass/(300 Kelvin);
EffectiveElectronMass["GaSb",t_:0]=0.042 ElectronMass;
EffectiveElectronMass["AlAs",t_:0]:=0.124 ElectronMass;
